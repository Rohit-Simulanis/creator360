...
function load(target, page) {
    ...
    setTimeout(function () {
        ...
        viewer.setImage("http://localhost:13000/uploads/Shivangi8/img/" + page, {
...
$.getJSON('parse.json', function(data) {
    console.log('data',data);
    var viewer = new eg.view360.PanoViewer(container, {
        image: "http://localhost:13000/uploads/Shivangi8/img/"+data.data.image, 
        useZoom: false,
        projectionType: eg.view360.PanoViewer.PROJECTION_TYPE.EQUIRECTANGULARString,
        cubemapConfig: {
            tileConfig: { flipHorizontal: true, rotation: 0 },
